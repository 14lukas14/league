 ...
 */
class Version20151203234910 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE le_address (id INT AUTO_INCREMENT NOT NULL, city VARCHAR(255) NOT NULL, province ENUM(\'dolnoslaskie\', \'wielkopolskie\') NOT NULL COMMENT \'(DC2Type:province_type)\', street VARCHAR(255) NOT NULL, post_code_number VARCHAR(255) NOT NULL, post_code_city VARCHAR(255) NOT NULL, number SMALLINT NOT NULL, flat VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fos_user (id INT AUTO_INCREMENT NOT NULL, leagues_id INT DEFAULT NULL, role VARCHAR(255) NOT NULL, pesel VARCHAR(255) DEFAULT NULL, gender ENUM(\'man\', \'woman\') NOT NULL COMMENT \'(DC2Type:gender_type)\', first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_957A64798642ED32 (leagues_id), INDEX role_idx (role), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE le_activist (id INT AUTO_INCREMENT NOT NULL, pesel VARCHAR(255) DEFAULT NULL, gender ENUM(\'man\', \'woman\') NOT NULL COMMENT \'(DC2Type:gender_type)\', first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE league_condition (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE le_player (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, pesel VARCHAR(255) DEFAULT NULL, gender ENUM(\'man\', \'woman\') NOT NULL COMMENT \'(DC2Type:gender_type)\', first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, INDEX IDX_38138A59296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE le_match (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE le_match_event (id INT AUTO_INCREMENT NOT NULL, match_id INT DEFAULT NULL, type ENUM(\'goal\', \'yellow_card\', \'red_card\', \'penalty\', \'break_match\', \'start_match\', \'end_match\', \'start_half\') NOT NULL COMMENT \'(DC2Type:match_event_type)\', minute SMALLINT DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_C4E30F192ABEACD6 (match_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE player_performance (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE le_season (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, active_season TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE league_condition');
        ...
        $this->addSql('DROP TABLE player_performance');
